...
CONCEPT_FAMILIES: dict[str, dict[str, list[str]]] = {
    ...
    "surrogate": {
        ...
        "en": ["surrogate", "feature-wise", "feature wise", "filim", "fi lm",
               ...
               "xgboost", "gradient boosting", "gradient-boosted",
               "decision tree", "tree ensemble", "boosting"],
        "zh": ["代理模型", "特征线性调制", "预测模型", "回归模型", "条件调制",
               "梯度提升", "决策树", "集成树"],
    },
    "active_learning": {
        "label_zh": "主动学习",
        "en": ["active learning", "acquisition function", "uncertainty sampling",
               "query strategy", "query-by-committee", "informativeness",
               "unlabeled", "annotation budget", "iteration query",
               "sample selection", "query the most"],
        "zh": ["主动学习", "获取函数", "不确定性采样", "查询策略",
               "查询委员会", "信息量", "未标注", "标注预算", "迭代查询",
               "样本选择"],
    },
    "generative_gan": {
        "label_zh": "生成对抗网络",
